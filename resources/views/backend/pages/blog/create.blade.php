        ...
        <div class="row">
            <div class="col-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        <form method="POST" enctype="multipart/form-data" action="{{ route('blog.add') }}">
                            @csrf
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-md-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="create_date" value="{{ old('create_date') }}">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea rows="4" name="long_description" class="form-control" id="long_description">{{ old('long_description') }}</textarea>
