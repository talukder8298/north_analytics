...
@section('page-title', 'Finance Details')
...
@section('content')
    <div class="main-content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <ol class="breadcrumb text-left text-black mt-10">
                                ...
                                <li class=" text-white"><a href="#">Finance Details</a></li>
                                <li class="active text-gray-silver">Finance Details</li>
                            </ol>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 blog-pull-right mt-30 mt-5">
                    <div class="single-service">
                        <img src="{{ asset('pictures/industries/'. $industry->image) }}" alt>
                        <h3 class="text-theme-colored line-bottom text-theme-colored">{{ $industry->name }}</h3>
